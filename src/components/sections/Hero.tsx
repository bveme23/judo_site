...
export function Hero({ title, subtitle, backgroundImage, ctaPrimary, ctaSecondary }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-bgDark via-primaryDark to-bgDark">
      ...
      {/* Fondo rojo (banner judo) — ahora en capa 1 */}
      <div
      ...
      {/* Imagen transparente (encima del rojo) — capa 2 */}
      {backgroundImage && (
        <div
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <Link href={ctaPrimary.link} className="btn-primary text-center shadow-red-lg hover:shadow-red-lg/80 transition-all duration-300">
                {ctaPrimary.text}
              </Link>
              {ctaSecondary && (
                <Link href={ctaSecondary.link} className="btn-secondary text-center backdrop-blur-md transition-all duration-300">
                  {ctaSecondary.text}
                </Link>
              )}
            </motion.div>
          ...
          >
            <img src="/logo.png?v=2" alt="J-Road Logo" className="w-full h-auto object-contain" />
          </motion.div>
